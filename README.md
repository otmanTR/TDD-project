...
TDD Project is ruby based and we implemented a class with methods by doing test-driven development (TDD).

**TDD Project** takes a number as input, if it is integer, give that integers factorials, if it is a string, gives that strings reverse string and taking the integer and gives result like fizz, buzz, fizzbuzz including their divisible 3 and 5.
...
We would like to thank microverse to give this opportunity to show up my skills
